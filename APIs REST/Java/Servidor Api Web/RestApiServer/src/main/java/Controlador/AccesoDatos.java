...
public class AccesoDatos {
    ...
    public List<Producto> listarProductosEnTabla(String patron) {
    ...
    public List<Proveedor> listarProveedoresEnTabla(String patron) {
    ...
    public List<Usuario> listarUsuariosEnTabla(String patron) {
