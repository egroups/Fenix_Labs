...
namespace Sistema.Forms.Proveedores
{
    public partial class Borrar : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                if (Session[session_name] != null)
                {
                    ...
                    if (funcion.valid_cookie(contenido))
                    {
                        ...
                        lblBorrar.Text = "Borrando al proveedor " + nombre;
                    }
                    else
                    {
        ...
        protected void btnBorrar_Click(object sender, EventArgs e)
        {
            ...
            {
                Application["mensaje"] = funcion.mensaje("Proveedor borrado");
                Response.Redirect("~/Forms/Proveedores/Index.aspx");
            }
            else
            {
                Application["mensaje"] = funcion.mensaje("Error borrando proveedor");
