    ...
    public partial class Agregar : System.Web.UI.Page
    {
        ...
        protected void btnAgregar_Click(object sender, EventArgs e)
        {
            if (txtNombre.Text != "" && txtDireccion.Text != "" && txtTelefono.Text != "")
            {
                ...
                {
                    Application["mensaje"] = funcion.mensaje("El proveedor " + proveedor.nombre + " ya existe");
                ...
                else
                {
                    ...
                    {
                        Application["mensaje"] = funcion.mensaje("Proveedor agregado");
                        Response.Redirect("~/Forms/Proveedores/Index.aspx");
                    }
                    else
                    {
                        Application["mensaje"] = funcion.mensaje("Error registrando proveedor");
                        Response.Redirect("~/Forms/Proveedores/Agregar.aspx");
                    }
                }
