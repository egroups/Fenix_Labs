    ...
    public partial class Agregar : System.Web.UI.Page
    {
        ...
        protected void btnAgregar_Click(object sender, EventArgs e)
        {
            if (txtNombre.Text != "" && txtClave.Text != "" && ddlTipo.Text != "")
            {
                ...
                {
                    Application["mensaje"] = funcion.mensaje("El usuario " + usuario.nombre + " ya existe");
                ...
                else
                {
                    ...
                    {
                        Application["mensaje"] = funcion.mensaje("Usuario agregado");
                        Response.Redirect("~/Forms/Usuarios/Index.aspx");
                    }
                    else
                    {
                        Application["mensaje"] = funcion.mensaje("Error registrando usuario");
                        Response.Redirect("~/Forms/Usuarios/Agregar.aspx");
                    }
                }
