    ...
    public partial class Agregar : System.Web.UI.Page
    {
        ...
        protected void btnAgregar_Click(object sender, EventArgs e)
        {
            if (txtNombre.Text != "" && txtDescripcion.Text != "" && txtPrecio.Text != "" && ddlProveedor.Text != "")
            {
                ...
                {
                    Application["mensaje"] = funcion.mensaje("El producto " + producto.nombre + " ya existe");
                ...
                else
                {
                    ...
                    {
                        Application["mensaje"] = funcion.mensaje("Producto agregado");
                        Response.Redirect("~/Forms/Productos/Index.aspx");
                    }
                    else
                    {
                        Application["mensaje"] = funcion.mensaje("Error registrando producto");
                        Response.Redirect("~/Forms/Productos/Agregar.aspx");
                    }
                }
