...
namespace Sistema.Forms.Productos
{
    public partial class Borrar : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                if (Session[session_name] != null)
                {
                    ...
                    if (funcion.valid_cookie(contenido))
                    {
                        ...
                        lblBorrar.Text = "Borrando al producto " + nombre;
                    }
                    else
                    {
        ...
        protected void btnBorrar_Click(object sender, EventArgs e)
        {
            ...
            {
                Application["mensaje"] = funcion.mensaje("Producto borrado");
                Response.Redirect("~/Forms/Productos/Index.aspx");
            }
            else
            {
                Application["mensaje"] = funcion.mensaje("Error borrando producto");
