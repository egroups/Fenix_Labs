...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="panel contenedor panel-default">
        <div class="panel-heading">
            <asp:Label ID="lblEditar" runat="server" Text="Editar Usuario"></asp:Label>
        </div>
            ...
            <fieldset>
                <div class="form-horizontal" role="form">
                    ...
                    <div class="form-group" name="form-group-nombre">
                        ...
                        <div class="col-lg-10">
                            <asp:TextBox ID="txtNombre" runat="server" placeholder="Ingrese nombre" CssClass="form-control" ReadOnly="True"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group" name="form-group-clave">
                        ...
                        <div class="col-lg-10">
                            <asp:TextBox ID="txtClave" runat="server" TextMode="Password" placeholder="Ingrese clave" CssClass="form-control" ReadOnly="True"></asp:TextBox>
                        </div>
                    </div>
