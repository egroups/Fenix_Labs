function AppViewModel() {
  ...
  self.AgregarProducto = function() {
    ...
    if(form_ready==true) {
      ...
      $.post("Administracion/Productos/Agregar", { nombre_producto: nombre_producto_check, descripcion: descripcion_check, precio: precio_check, id_proveedor: proveedor_check }, function (data) {
  ...
  self.borrarProducto = function(Producto) {
    ...
    function(isConfirm){
      if (isConfirm) {
        var id = Producto.id;
        $.post("Administracion/Productos/Borrar", { id_producto: id }, function (data) {
  ...
  self.GrabarEdicionProducto = function() {
    ...
    if(form_ready==true) {
      ...
      $.post("Administracion/Productos/Editar", { id_producto: Producto.id, nombre_producto: Producto.nombre_producto, descripcion: Producto.descripcion, precio: Producto.precio, id_proveedor: Producto.id_proveedor }, function (data) {
  ...
  self.AgregarProveedor = function() {
    ...
    if(form_ready==true) {
  	  ...
  	  $.post("Administracion/Proveedores/Agregar", { nombre_empresa: nombre_empresa_check, direccion: direccion_check, telefono: telefono_check, fecha_registro: fecha_registro_check }, function (data) {
  ...
  self.GrabarEdicionProveedor = function() {
    ...
    if(form_ready==true) {
        ...
        $.post("Administracion/Proveedores/Editar", { id_proveedor: Proveedor.id, nombre_empresa: Proveedor.nombre_empresa, direccion: Proveedor.direccion, telefono: Proveedor.telefono }, function (data) {
  ...
  self.borrarProveedor = function(Proveedor) {
    ...
    function(isConfirm){
      if (isConfirm) {
        var id = Proveedor.id;
        $.post("Administracion/Proveedores/Borrar", { id_proveedor: id }, function (data) {
  ...
  self.AgregarUsuario = function() {
    ...
    if(form_ready==true) {
      ...
      $.post("Administracion/Usuarios/Agregar", { nombre_usuario: nombre_usuario_check, password: clave_check, tipo: tipo_check, fecha_registro: fecha_registro_check }, function (data) {
  ...
  self.GrabarEdicionUsuario = function() {
    ...
    if(form_ready==true) {
      ...
      $.post("Administracion/Usuarios/Editar", { id_usuario: Usuario.id, tipo: Usuario.tipo }, function (data) {
  ...
  self.borrarUsuario = function(Usuario) {
    ...
    function(isConfirm){
      if (isConfirm) {
        var id = Usuario.id;
        $.post("Administracion/Usuarios/Borrar", { id_usuario: id }, function (data) {
  ...
  self.CambiarUsuario = function() {
    ...
    if(form_ready==true) {
      ...
      $.post("Cuenta/CambiarUsuario", { username: nombre_usuario_check, new_username: nuevo_usuario_check(), password: actual_contraseña_check() }, function (data) {
  ...
  self.CambiarPassword = function() {
    ...
    if(form_ready==true) {
      ...
      $.post("Cuenta/CambiarPassword", { username: nombre_usuario_check, anterior_password: actual_contraseña_check(), new_password: nueva_contraseña_check() }, function (data) {
