...
if( isset($_POST['type']) && !empty( isset($_POST['type']) ) ){
	...
	switch ($type) {
		...
		case "generarCookie":
			generar_cookie();
			break;
		case "descifrarCookie":
			descifrar_cookie();
			break;
		case "verificarCookie":
			verificar_cookie();
...
function generar_cookie() {
	$username = $_POST["username"];
	$password = $_POST["password"];
	$data = array();

	$code = base64_encode($username.":".md5($password));
...
function descifrar_cookie() {
	$code = base64_decode($_POST["contenido"]);
