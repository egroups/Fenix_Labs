	...
	$scope.newProveedor = function(){
		...
		if(form_ready==true) {
			...
			$http({
			  ...
			  data: $.param({'type' : 'addProveedor','nombre_empresa' : $scope.proveedor["nombre_empresa"], 'direccion' : $scope.proveedor["direccion"] , 'telefono': $scope.proveedor["telefono"], 'fecha_registro' : $scope.proveedor["fecha_registro_proveedor"] }),
