...
class FormBorrarUsuario extends AbstractType
{
    /**
     * {@inheritdoc}
     */
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('borrarUsuario',SubmitType::class, array('label' => 'Eliminar', 'attr' => array('class' => 'btn-lg btn-danger btn-block')));
