	...
	if($username=="" or $password=="") {
		...
		if($conexion_now->ingreso_usuario($username,$password_encoded)) {
			...
			if($conexion_now->es_admin($username)) {
				mensaje_con_redireccion("Notificacion","Bienvenido administrador ".htmlentities($username),"success",$archivo);
			} else {
				mensaje_con_redireccion("Notificacion","Bienvenido usuario ".htmlentities($username),"success",$archivo);
			}
		} else {
