...
public class FormProductos extends javax.swing.JFrame {
    ...
    public void cargarCamposProducto(int id_producto_to_load) {
        ...
        AccesoDatos datos = new AccesoDatos();
        Producto producto = datos.listarProductoEnTabla(id_producto_to_load);
    ...
    public void grabar() {
        ...
        if (validar()) {
            ...
            if (nuevo) {
                sql = "insert into productos(nombre_producto,descripcion,precio,id_proveedor,fecha_registro) values('" + p.getNombre_producto() + "','" + p.getDescripcion() + "'," + p.getPrecio() + "," + codigoProveedor + ",'" + p.getFecha_registro() + "')";
            } else {
                sql = "update productos set nombre_producto='" + p.getNombre_producto() + "',descripcion='" + p.getDescripcion() + "',precio=" + p.getPrecio() + ",id_proveedor=" + codigoProveedor + " where id_producto=" + p.getId_producto();
            }
