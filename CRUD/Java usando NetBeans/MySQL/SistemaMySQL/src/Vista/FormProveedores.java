...
public class FormProveedores extends javax.swing.JFrame {
    ...
    public void cargarCamposProveedor(int id_proveedor_to_load) {
        ...
        AccesoDatos datos = new AccesoDatos();
        Proveedor proveedor = datos.listarProveedorEnTabla(id_proveedor_to_load);
        int id_proveedor = proveedor.getId_proveedor();
        String nombre_empresa = proveedor.getNombre_empresa();
        String direccion = proveedor.getDireccion();
        int telefono = proveedor.getTelefono();
    ...
    public void grabar() {
        ...
        if (validar()) {
            ...
            if (nuevo) {
                sql = "insert into proveedores(nombre_empresa,direccion,telefono,fecha_registro_proveedor) values('" + p.getNombre_empresa() + "','" + p.getDireccion() + "'," + p.getTelefono() + ",'" + p.getFecha_registro() + "')";
            } else {
                sql = "update proveedores set nombre_empresa='" + p.getNombre_empresa() + "',direccion='" + p.getDireccion() + "',telefono=" + p.getTelefono() + " where id_proveedor=" + p.getId_proveedor();
            }
