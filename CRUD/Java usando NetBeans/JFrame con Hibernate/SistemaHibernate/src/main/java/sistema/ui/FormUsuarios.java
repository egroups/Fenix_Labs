...
public class FormUsuarios extends javax.swing.JFrame {
    ...
    public void cargarListaUsuarios() {
        ...
        for (int i = 0; i < listaUsuarios.size(); i++) {
            ...
            String fecha_registro = funcion.convertir_fecha_para_usuario(usuario.getFechaRegistro());
    ...
    public void asignar(String tipo_usuario) {
        ...
        if (row >= 0) {
            AccesoDatos datos = new AccesoDatos();
            Usuarios usuario = datos.cargarUsuarioEnTabla(id_usuario_to_load);
            int id_usuario = usuario.getIdUsuario();
            ...
            if (resultado == JOptionPane.YES_OPTION) {
                ...
                if (datos.editarUsuario(id_usuario, "", "", tipo, "")) {
    ...
    public void borrar() {
        ...
        if (row >= 0) {
            ...
            if (resultado == JOptionPane.YES_OPTION) {
                ...
                if (datos.borrarUsuario(id_usuario)) {
    ...
    public void grabar() {
        ...
        if (validar()) {
            ...
            if (nuevo) {
                if (datos.comprobar_existencia_usuario_crear(usuario.getUsuario())) {
                    ...
                    if (datos.agregarUsuario(usuario.getUsuario(), usuario.getClave(), usuario.getTipo(), usuario.getFechaRegistro())) {
                ...
                if (datos.editarUsuario(usuario.getIdUsuario(), "", "", usuario.getTipo(), "")) {
