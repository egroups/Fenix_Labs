...
public class FormCambiarUsuario extends javax.swing.JFrame {

    /**
     * Creates new form FormCambiarUsuario
     */
    public String username;

    public FormCambiarUsuario() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblNuevoNombreUsuario = new javax.swing.JLabel();
        ...
        lblNuevoNombreUsuario.setText("Nombre de usuario : ");
        ...
        jpDatosLayout.setHorizontalGroup(
            ...
            .addGroup(jpDatosLayout.createSequentialGroup()
                ...
                .addGroup(jpDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jpDatosLayout.createSequentialGroup()
                        .addComponent(lblNuevoNombreUsuario)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtNuevoNombreUsuario))
                    .addGroup(jpDatosLayout.createSequentialGroup()
    ...
    private void btnCambiarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCambiarActionPerformed
        ...
        if ("".equals(txtUsuarioActual.getText()) || "".equals(txtPassword.getText()) || "".equals(txtNuevoNombreUsuario.getText())) {
            JOptionPane.showMessageDialog(this, "Faltan datos");
        } else {
            String usuario = txtUsuarioActual.getText();
            String nuevo_nombre = txtNuevoNombreUsuario.getText();
            String password = funciones.md5_encode(txtPassword.getText());
            if (datos.ingreso_usuario(usuario, password)) {
                int id_usuario = datos.get_id_by_username(usuario);
                if (datos.comprobar_existencia_usuario_editar(nuevo_nombre)) {
                    JOptionPane.showMessageDialog(this, "El usuario " + nuevo_nombre + " ya existe");
                } else {
                    String sql = "update usuarios set usuario='" + nuevo_nombre + "' where usuario='" + usuario + "'";
                    if (datos.cargarConsulta(sql)) {
                        JOptionPane.showMessageDialog(this, "El nombre de usuario ha sido cambiado exitosamente , reinicie la aplicacion");
                        System.exit(0);
                    } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormCambiarUsuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormCambiarUsuario().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel lblNuevoNombreUsuario;
