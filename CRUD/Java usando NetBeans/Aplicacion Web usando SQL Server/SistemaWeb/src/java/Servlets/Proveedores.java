                    ...
                    if (request.getParameter("agregar_proveedor") != null) {
                        ...
                        if (!"".equals(nombre_empresa) && !"".equals(direccion) && funcion.valid_number(telefono) && !"".equals(fecha_registro)) {
                            if (conexion_now.comprobar_existencia_proveedor_crear(nombre_empresa)) {
                                out.println(funcion.Redirect("El proveedor " + nombre_empresa + " ya existe", "administracion.jsp?proveedores"));
                            } else {
                                String sql = "insert into proveedores values('" + nombre_empresa + "','" + direccion + "'," + telefono + ",'" + fecha_registro + "')";
                                if (conexion_now.cargarConsulta(sql)) {
                                    out.println(funcion.Redirect("Proveedor registrado", "administracion.jsp?proveedores"));
                                } else {
                                    out.println(funcion.Redirect("Ha ocurrido un error en la base de datos", "administracion.jsp?proveedores"));
                                }
                            }
                        } else {
                            out.println(funcion.Redirect("Faltan datos", "administracion.jsp?proveedores"));
                        }

                    } else if (request.getParameter("actualizar_proveedor") != null) {
                        ...
                        if (funcion.valid_number(id_proveedor) && !"".equals(nombre_empresa) && !"".equals(direccion) && funcion.valid_number(telefono)) {
                            if (conexion_now.comprobar_existencia_proveedor_editar(Integer.parseInt(id_proveedor), nombre_empresa)) {
                                ...
                                if (conexion_now.cargarConsulta(sql)) {
                                    out.println(funcion.Redirect("Proveedor editado", "administracion.jsp?proveedores"));
                                } else {
                                    out.println(funcion.Redirect("Ha ocurrido un error en la base de datos", "administracion.jsp?proveedores"));
                                }
                            }
                        ...
                        if (funcion.valid_number(id_proveedor)) {
                            ...
                            if (conexion_now.cargarConsulta(sql)) {
                                out.println(funcion.Redirect("Proveedor borrado", "administracion.jsp?proveedores"));
                            } else {
                                out.println(funcion.Redirect("Ha ocurrido un error en la base de datos", "administracion.jsp?proveedores"));
                            }
                        } else {
                            out.println(funcion.Redirect("ID invalido", "administracion.jsp?proveedores"));
                        }
                    } else {
