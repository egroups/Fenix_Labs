            ...
            if (request.getParameter("LogOn") != null) {
                ...
                if (!"".equals(nombre_usuario) && !"".equals(password)) {
                    ...
                    if (conexion_now.ingreso_usuario(nombre_usuario, password_encoded)) {
                        ...
                        out.println(funcion.Redirect(mensaje, "administracion.jsp"));

                    } else {
                        out.println(funcion.Redirect("Datos invalidos", "login.jsp"));
                    }
                } else {
                    out.println(funcion.Redirect("Faltan datos", "login.jsp"));
                }
                ...
                if (cookies != null) {
                    if (funcion.validar_cookie(cookies)) {
                        ...
                        out.println(funcion.Redirect("Las cookies han sido borradas", "login.jsp"));
                    } else {
                        out.println(funcion.Redirect("No has iniciando una sesion", "login.jsp"));
                    }
                } else {
                    out.println(funcion.Redirect("No has iniciando una sesion", "login.jsp"));
                }
