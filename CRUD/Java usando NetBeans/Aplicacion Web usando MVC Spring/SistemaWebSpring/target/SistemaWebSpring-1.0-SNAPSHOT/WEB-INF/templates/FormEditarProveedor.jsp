...
<div class="panel contenedor panel-default">
    <div class="panel-heading">Editando al proveedor ${Proveedor.nombre_empresa}</div>
        ...
        <form:form class="form-horizontal" role="form" method="post" action="${context}/administracion/proveedores/editar" commandName="Proveedor">
            <fieldset>
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-primary center-block" name="editar_proveedor" id="agregar_proveedor">Editar</button>
                </div>
